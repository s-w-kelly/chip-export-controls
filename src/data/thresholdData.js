...
export const thresholdHistory = [
  {
    ...
    notes: ` 
      ...
      <p>Throughout the first half of 2026, there have been <a href="https://chipbriefing.substack.com/p/daily-beijing-to-allow-h200-chips">several reports</a> that China was finally allowing H200 imports, most recently in early July. However, whether this actually goes through remains to be seen.</p>
