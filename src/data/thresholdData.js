...
export const thresholdHistory = [
  {
    ...
    notes: ` 
      ...
      <p>In early March, Bloomberg <a href="https://chipbriefing.substack.com/p/daily-us-considers-h200-sales-cap>reported</a> that the White House may cap the sale of H200s and AMD MI325X chips at 75,000 per Chinese client, but by this point still has not received guidance from Beijing on whether the Chinese government would even allow the chips to be imported.</p>
