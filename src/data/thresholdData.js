...
export const thresholdHistory = [
  {
    ...
    notes: ` 
      ...
      <p>After agreeing at the end of 2025 to allow NVIDIA to export H200s to China, the Trump Administration is also <a href="https://ifp.org/the-b30a-decision/">reportedly considering</a> allowing exports of NVIDIA’s forthcoming B30A chip. The B30A is essentially half of a B300 (using one Blackwell logic die instead of two, and four HBM stacks instead of eight) but still has a TPP of around 2x the H200, which would make the B30A by far the most powerful chip allowed to be exported to China.
      </p>
      `,
  },
  {
