...
export const thresholdHistory = [
  {
    ...
    notes: ` 
      ...
      Government officals further <a href="https://www.reuters.com/world/china/chinas-customs-agents-told-nvidias-h200-chips-are-not-permitted-sources-say-2026-01-14/">instructed</a> companies not to purchase the chips “unless necessary,” and “[t]he wording from the officials is so severe that it is basically a ban for now, though this might change in the future should things evolve.”</p>
      <p>After <a href="https://chipbriefing.substack.com/p/daily-beijing-to-allow-h200-chips">several reports</a> throughout the first half of 2026 that China was finally allowing H200 imports, the first chips were <a href="https://chipbriefing.substack.com/p/daily-h200s-finally-make-it-to-china">finally shipped</a> in mid-July.</p>
      <p>To implement the H200 export agreement, on January 13 BIS <a href="https://www.bis.gov/press-release/department-commerce-revises-license-review-policy-semiconductors-exported-china">announced</a> a rule allowing case-by-case exports of otherwise controlled chips to China and Macau, under which the H200 and AMD MI325X fall. Notably, the rule requires chips to undergo third-party review by a U.S.-based testing facility before export. This is seemingly a work-around to the Constitution’s Export Clause, which states that “No Tax or Duty shall be laid on Articles exported from any State.” By forcing the chips to be sent to the U.S. after fabrication in Taiwan, the 25% cut can be collected as an import tariff before export to China. However, the Export Clause was intended to be—and has been interpreted as—<a href="https://constitution.congress.gov/browse/essay/artI-S9-C5-1/ALDE_00013596/">extremely broad</a>: “not simply an omission of a tax upon the articles exported, but also a freedom from any tax which directly burdens” the process of exporting. Ultimately, <a href="https://www.cato.org/commentary/trumps-unconstitutional-export-tax-probably-here-stay">experts</a> <a href="https://www.forbes.com/sites/taxnotes/2025/09/16/the-nvidia-deal-and-taxing-exports-the-constitutionality-of-it-all/">believe</a> the 25% cut is unconstitutional, but no third parties likely have <a href="https://www.law.cornell.edu/constitution-conan/article-3/section-2/clause-1/overview-of-standing">standing</a> to sue and strike down the deal in court.</p>
      <p>In conjunction with the BIS rule, the White House <a href="https://www.whitehouse.gov/presidential-actions/2026/01/adjusting-imports-of-semiconductors-semiconductor-manufacturing-equipment-and-their-derivative-products-into-the-united-states/">issued</a> a Proclamation establishing a 25% tariff on chips within two narrow bands, which target the H200 and MI325X.</p>
      ...
      <p>Note also the location of the H200 rule: section 742.6(b)(10)(iii) is also where the Diffusion Rule per-country GPU caps are (in subparagraph B); in other words, the H200 rule was bascially bolted on to the not-actually-rescinded Diffusion Rule. This illustrates the messiness and potential confusion created by BIS failing to formally rescind Biden’s Rule and issue a replacement (see more below).</p>
      ...
      <p>Exports of other chips have also faced bureaucratic struggles and uncertainty. Bloomberg <a href="https://www.bloomberg.com/news/articles/2026-04-10/trump-s-ai-chip-export-push-stymied-by-bureaucratic-bottleneck">reported</a> a significant bottleneck in chip license approvals by the Bureau of Industry and Security stemming from loss of staff/high turnover combined with a heavy workload on matters beyond AI chips, such as the war in Iran.</p>
      <p><strong>The Diffusion Rule’s Lingering Legal Status</strong></p>
      <p>Because BIS never formalized its rescission of the 2025 Diffusion Rule (see 2025 entry), the Rule’s worldwide licensing requirements have remained technically on the books, creating uncertainty about what the regulations actually require versus what the Administration is willing to enforce. Two developments in 2026 brought this tension to a head.</p>
      <p>First, on May 12, the Government Accountability Office <a href="https://www.gao.gov/products/b-337935">determined</a> that BIS’s May 2025 press release announcing that it would not enforce the Diffusion Rule was itself a “rule” for purposes of the <a href="https://www.pillsburylaw.com/en/news-and-insights/gao-commerce-non-enforcement-ai-diffusion-rule-congressional-review-act.html">Congressional Review Act</a> (which adopts the definition of a “rule” under the Administrative Procedure Act), meaning it should have been submitted to Congress before taking effect. The <a href="https://www.onelexpartners.com/news-and-insights/us-export-controls-and-ai-a-practitioners-guide">practical upshot</a> is that the Diffusion Rule is not only still on the books but is legally in effect notwithstanding the non-enforcement posture.</p>
      <p>Second, on Sunday, May 31, BIS issued <a href="https://www.bis.gov/media/documents/bis-guidance-may-31-2026.pdf">guidance</a> clarifying that its non-enforcement of the Diffusion Rule did not apply to the preexisting destination-based license requirement—first established in 2023 and codified at <a href="https://www.ecfr.gov/current/title-15/part-742/section-742.6#p-742.6(a)(6)(iii)">15 C.F.R. § 742.6(a)(6)(iii)</a>—for advanced computing items destined for entities headquartered in (or with an ultimate parent company headquartered in) Group D:5 or Macau. BIS explained that it had <a href="https://sanctionsnews.bakermckenzie.com/bis-clarifies-that-license-requirements-for-advanced-computing-items-to-country-group-d5-and-macau-headquartered-entities-remain-in-force-despite-ai-diffusion-rule-non-enforcement/">received questions</a> on this point: because the Diffusion Rule had restructured these EAR provisions, BIS’s decision not to enforce the Diffusion Rule had cast doubt on whether the underlying 2023 China/Macau controls still applied. According to <a href="https://www.chinatalk.media/p/emergency-pod-claude-fable-fried#:~:text=we%E2%80%99re%20just%20going%20to%20take%20the%20law%20literally">Biden Administration official Chris McGuire</a>, some companies took the law literally to circumvent controls; i.e., interpreting the seeming lack of an explicit prohibition on sending chips to Chinese-headquartered companies’ overseas affiliates (i.e., entities headquartered in D:5/Macau but located elsewhere) as permission to sell to them without a license. <a href="https://www.chinatalk.media/p/emergency-pod-claude-fable-fried#:~:text=we%E2%80%99re%20just%20going%20to%20take%20the%20law%20literally">McGuire noted</a> that it is unclear “who took advantage of this or in what magnitude — that information is still yet to be revealed. But what I do know is companies were telling people this was a legally permissible route to take. And there are a lot of rumors that some things were shipped pursuant to this loophole.” So, BIS had to issue emergency guidance to confirm that its core China-facing controls were still in effect and close this supposed loophole.</p>
      ...
      The legislation was <a href="https://www.congress.gov/bill/119th-congress/house-bill/6875/text">introduced</a> in late 2025 response to the Trump Administration’s approval of H200 exports to China, and the law would also ban exports of Blackwell generation chips, which the Trump Administration has <href="https://ifp.org/the-b30a-decision/">reportedly</a> been considering.</p>
      <p>On July 15, BIS issued a <a href="https://www.federalregister.gov/documents/2026/07/14/2026-14132/enhanced-favorable-treatment-for-the-united-arab-emirates-under-the-export-administration">Final Rule</a> upgrading the UAE from Country Groups D:3 and D:4 to Country Group A:5 under the Export Administration Regulations. The <a href="https://media.bis.gov/press-release/department-commerce-eases-export-controls-uae">BIS Press Release</a> stated that this action was “in recognition of the UAE’s status as a U.S. Major Defense Partner and its support in advancing U.S. national security interests, including Operation Epic Fury,” and emphasized military exports. However, BIS also noted that “consistent with the U.S.-UAE Artificial Intelligence Cooperation framework signed in May 2025, Commerce is approving the UAE Government and certain companies to receive advanced computing items in the UAE license-free, including AI chips and servers.”
      `,
  ...
  },
  {
    ...
    rule: "",
    notes: ` 
      <p>In the final days of his term, President Biden released a sweeping interim final rule titled <a href="https://www.federalregister.gov/documents/2025/01/15/2025-00636/framework-for-artificial-intelligence-diffusion">“Framework for Artificial Intelligence Diffusion</a>.” In brief, this “AI Diffusion Rule” <a href="https://www.rand.org/pubs/perspectives/PEA3776-1.html">would have created</a> a three-tiered system controlling which countries can import advanced AI chips (with per-country caps on H100-equivalent GPUs) as well as certain model weights.</p>  
      <p>However, days before the rule was set to take effect, the Trump Administration <a href="https://www.bis.gov/press-release/department-commerce-announces-rescission-biden-era-artificial-intelligence-diffusion-rule-strengthens">announced</a> that it would not enforce the Diffusion Rule. BIS stated that it would publish a regulation formalizing the rescission and issue a replacement rule in the future; however, neither of these steps has occurred. As a result, the Diffusion Rule’s sweeping worldwide licensing requirements <a href="https://www.chinatalk.media/p/emergency-pod-claude-fable-fried#:~:text=The%20AI%20diffusion%20rule%20is%20still%20on%20the%20books">technically remain on the books</a> (see, e.g., License Exception AIA, <a href="https://www.ecfr.gov/current/title-15/section-740.27">15 C.F.R. § 740.27</a>, and the per-country allocation cap of 790,000,000 TPP at <a href="https://www.ecfr.gov/current/title-15/part-742/section-742.6#p-742.6(b)(10)(iii)(B)">§ 742.6(b)(10)(iii)(B)</a>) under a mere non-enforcement posture. This has created legal uncertainty and enforcement issues (see 2026 entry).</p>
      <p>Instead of creating a global framework to replace the Diffusion Rule, the Trump Administration <a href="https://carnegieendowment.org/emissary/2025/05/ai-chip-trump-gulf-uae-saudi-security-risk-good-deal?lang=en">has pursued</a> individual deals with countries, starting with Saudi Arabia and the United Arab Emirates. Rather than restrict AI diffusion as the Biden Administration attempted, the Saudia Arabia/UAE deals and other Trump Administration actions led by advisor David Sacks reflect <a href="https://thezvi.substack.com/i/164743152/when-david-sacks-says-win-the-ai-race-he-literally-means-market-share">a different emphasis</a> on aggressively exporting “the American tech stack.” Sacks has interpreted “winning the AI race” as “achiev[ing] a decisive advantage that can be measured in market share.”</p>
