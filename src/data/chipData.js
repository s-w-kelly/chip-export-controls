...
export const chipData = [
  ...
  },
  {
    ...
    fp4: "35000 training, 25000 inference",
    fp8: 17500,
    fp16: 4000,
    bf16: 4000,
    tf32: 2000,
    int8: 250,
    dieArea: "1456 mm² (estimate)",
    ...
    eccn: "3A090.a",
    notes: "Specs and threshold metrics based on initial NVIDIA press releases/blog posts in early 2026. TPP calculated based on NVFP4 training performance and die area is not officially known, so TPP/PD should be considered rough estimates.",
    sources: [
      { name: "Vera Rubin NVL72 press release (performance, specs)", url: "https://www.nvidia.com/en-us/data-center/vera-rubin-nvl72/" },
      { name: "Semicon (process node)", url: "https://www.semicone.com/article-179.html" },
      { name: "TechPowerUp (die area)", url: "https://www.techpowerup.com/gpu-specs/rubin-gpu.c4425" },
    ]
  },
  {
    name: "NVIDIA B30A",
    ...
    tdp: null,
    controlStatus: "Potentially Exportable",
    eccn: "3A090.a",
  ...
  },
  {
    ...
    sources: [
      ...
      { name: "SemiAnalysis (die area)", url: "https://newsletter.semianalysis.com/p/can-amd-break-the-cuda-moat-amd-advancing." },
