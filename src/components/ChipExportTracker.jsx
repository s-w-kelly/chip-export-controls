                    ...
                    <>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '16px', marginBottom: '20px' }}>
                        <div>
                          ...
                          <div style={{ fontSize: '16px', color: '#ffffff' }}>{chip.fp8Dense ? `${chip.fp8Dense} TFLOPS` : '—'}</div>
                        </div>
                        <div>
                          <div style={{ fontSize: '11px', color: '#6b7280', textTransform: 'uppercase', marginBottom: '4px' }}>FP16 Dense</div>
                          <div style={{ fontSize: '16px', color: '#ffffff' }}>{chip.fp16Dense ? `${chip.fp16Dense} TFLOPS` : '—'}</div>
                        </div>
                        <div>
                          <div style={{ fontSize: '11px', color: '#6b7280', textTransform: 'uppercase', marginBottom: '4px' }}>INT8 Dense</div>
                          <div style={{ fontSize: '16px', color: '#ffffff' }}>{chip.int8Dense ? `${chip.int8Dense} TOPS` : '—'}</div>
                        </div>
                        <div>
